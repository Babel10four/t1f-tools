...
export function ToolsWorkbenchShell({ children, role }: Props) {
  // Standard users reach Credit Copilot from its dedicated rail tab, so the persistent
  // sidebar chat is redundant for them; keep it only for admins.
  const showCopilotPanel = role === "admin";
