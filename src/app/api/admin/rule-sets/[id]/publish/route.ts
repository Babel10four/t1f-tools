...
import { publishRuleSet } from "@/lib/rule-sets/service";
...
export async function POST(
  ...
  try {
    ...
    enqueuePlatformEvent({
      ...
      toolKey: null,
      route: "/api/admin/rule-sets/[id]/publish",
      status: "success",
      metadata: { ruleSetId: id, action: "publish" },
    });
    ...
    enqueuePlatformEvent({
      ...
      route: "/api/admin/rule-sets/[id]/publish",
      status: "error",
      metadata: { ruleSetId: id, action: "publish", code: code || "unknown" },
    });
    if (code === "NOT_FOUND") {
